...
var analizadorLexico = /** @class */ (function () {
    ...
    analizadorLexico.prototype.analizadorC = function () {
        Tipo_dato = "";
        Nombre_dato = "";
        Linea_dato = 1;
        var ListaHtml = "";
    ...
    analizadorLexico.prototype.esEspacio = function (c) {
        if (c == '\n') {
            Linea_dato++;
        }
        return c == '\n' || c == '\t' || c == ' ';
    ...
    analizadorLexico.prototype.imprimirListaS = function () {
        var auxiliar = "Token    -------   Lexema\n";
    ...
    analizadorLexico.prototype.addList = function (lex, token) {
        listaLexema.push(lex);
        listaToken.push(token);
        Linea_de_datos.push(Linea_dato.toString());
        auxLex = "";
    };
    analizadorLexico.prototype.addListH = function (lex, token) {
        listaLexemaH.push(lex);
        listaTokenH.push(token);
        auxLex = "";
    };
    analizadorLexico.prototype.addListS = function (lex, token) {
        listaLexemaS.push(lex);
        listaTokenS.push(token);
    };
    analizadorLexico.prototype.main = function () {
        this.analizadorC();
    };
    return analizadorLexico;
}());
function iniciar() {
    var p = new analizadorLexico();
    p.main();
}
